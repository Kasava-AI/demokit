...
export const queryParamConfigSchema = z.object({
  ...
  pagination: z
    ...
    .optional(),
  envelope: z.enum(['bare', 'data-total-page']).optional(),
})
...
export const createEndpointMappingSchema = z.object({
  ...
  aggregateConfig: aggregateConfigSchema.optional().nullable(),
  transformName: z.string().optional().nullable(),
  queryParamConfig: queryParamConfigSchema.optional().nullable(),

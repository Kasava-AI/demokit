  ...
  try {
      ...
      const createdMappings = await db
        ...
        .values(
          validatedData.mappings.map((mapping) => ({
            ...
            aggregateConfig: mapping.aggregateConfig,
            transformName: mapping.transformName,
            queryParamConfig: mapping.queryParamConfig,
    ...
    const [mapping] = await db
      ...
      .values({
        ...
        aggregateConfig: validatedData.aggregateConfig,
        transformName: validatedData.transformName,
        queryParamConfig: validatedData.queryParamConfig,
